...
def get_or_create_staff_agent(user_id: str, user_name: str) -> StaffAgent:
    """
...
def get_or_create_manager_agent(user_id: str, user_name: str) -> ManagerAgent:
    """
