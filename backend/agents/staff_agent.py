...
当用户表示"完成了"、"确认完成"、"可以了"等意图时，你必须：

1. 生成反馈总结（给业务负责人看）
2. **立即调用 update_task_status 工具** 提交任务完成
...
{{
  ...
  "arguments": {{
    ...
    "status": "已完成",
    "feedback_summary": "这里是给业务负责人看的反馈总结，包含核查结论、处理说明、证明材料"
  }}
}}
```

**注意**：
- status 必须填写 "已完成"（不是"反馈完成"）
- feedback_summary 是必填的，给业务负责人汇报核查结果
- 调用工具后，任务才算真正完成"""
